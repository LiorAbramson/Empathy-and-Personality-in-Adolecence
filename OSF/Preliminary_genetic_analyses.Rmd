...
This script performs all the preliminary analyses and examines twins' ICC in the study variables
before conducting the biometric cross-lagged analysis in the Mx software 
...
examining attrition effects: are there differences in study variables 
between adolecents who participated in one or two time points?
```{r}
#build the variable indicating whether the participant was in one or two time points
  Dfinal_11_13$whatStage <- 0
  Dfinal_11_13$whatStage[is.na(Dfinal_11_13$EMPQ_emotional_11)== F &is.na(Dfinal_11_13$EMPQ_emotional_13)== F] <-1   

#perform separate t-test for each study outcome
  ttest_whatStage_emo11 <- t.test(EMPQ_emotional_11~whatStage, data=Dfinal_11_13)
  ttest_whatStage_cog11 <- t.test(EMPQ_cognitive_11~whatStage, data=Dfinal_11_13)
  ttest_whatStage_predemo11 <- t.test(predicted_emotional_11~whatStage, data=Dfinal_11_13)
  ttest_whatStage_predcog11 <- t.test(predicted_cognitive_11~whatStage, data=Dfinal_11_13)
  
  ttest_whatStage_emo13 <- t.test(EMPQ_emotional_13~whatStage, data=Dfinal_11_13)
  ttest_whatStage_cog13 <- t.test(EMPQ_cognitive_13~whatStage, data=Dfinal_11_13)
  ttest_whatStage_predemo13 <- t.test(predicted_emotional_13~whatStage, data=Dfinal_11_13)
  ttest_whatStage_predcog13 <- t.test(predicted_cognitive_13~whatStage, data=Dfinal_11_13)
...
#add effect size
  ...
  ttest_attritionTable_edit$cohenD[1] <- 0-round(cohensD(predicted_emotional_11~whatStage, data=Dfinal_11_13),2)
  ttest_attritionTable_edit$cohenD[2] <- 0-round(cohensD(EMPQ_emotional_11~whatStage, data=Dfinal_11_13),2)
  ttest_attritionTable_edit$cohenD[3] <- 0-round(cohensD(predicted_emotional_13~whatStage, data=Dfinal_11_13),2)
  ttest_attritionTable_edit$cohenD[4] <- 0-round(cohensD(EMPQ_emotional_13~whatStage, data=Dfinal_11_13),2)
  
  ttest_attritionTable_edit$cohenD[5] <- 0-round(cohensD(predicted_cognitive_11~whatStage, data=Dfinal_11_13),2)
  ttest_attritionTable_edit$cohenD[6] <- 0-round(cohensD(EMPQ_cognitive_11~whatStage, data=Dfinal_11_13),2)
  ttest_attritionTable_edit$cohenD[7] <- 0-round(cohensD(predicted_cognitive_13~whatStage, data=Dfinal_11_13),2)
  ttest_attritionTable_edit$cohenD[8] <- 0-round(cohensD(EMPQ_cognitive_13~whatStage, data=Dfinal_11_13),2)

#add sd
  ttest_attritionTable_edit$sd1Stage <- NA
  ttest_attritionTable_edit$sd2Stage <- NA
  
  ttest_attritionTable_edit$sd1Stage[1] <- round((aggregate(Dfinal_11_13$predicted_emotional_11~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  ttest_attritionTable_edit$sd1Stage[2] <- round((aggregate(Dfinal_11_13$EMPQ_emotional_11~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  ttest_attritionTable_edit$sd1Stage[3] <- round((aggregate(Dfinal_11_13$predicted_emotional_13~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  ttest_attritionTable_edit$sd1Stage[4] <- round((aggregate(Dfinal_11_13$EMPQ_emotional_13~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)

  ttest_attritionTable_edit$sd1Stage[5] <- round((aggregate(Dfinal_11_13$predicted_cognitive_11~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  ttest_attritionTable_edit$sd1Stage[6] <- round((aggregate(Dfinal_11_13$EMPQ_cognitive_11~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  ttest_attritionTable_edit$sd1Stage[7] <- round((aggregate(Dfinal_11_13$predicted_cognitive_13~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  ttest_attritionTable_edit$sd1Stage[8] <- round((aggregate(Dfinal_11_13$EMPQ_cognitive_13~Dfinal_11_13$whatStage, FUN = sd)[1,2]),2)
  
  ttest_attritionTable_edit$sd2Stage[1] <- round((aggregate(Dfinal_11_13$predicted_emotional_11~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  ttest_attritionTable_edit$sd2Stage[2] <- round((aggregate(Dfinal_11_13$EMPQ_emotional_11~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  ttest_attritionTable_edit$sd2Stage[3] <- round((aggregate(Dfinal_11_13$predicted_emotional_13~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  ttest_attritionTable_edit$sd2Stage[4] <- round((aggregate(Dfinal_11_13$EMPQ_emotional_13~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  
  ttest_attritionTable_edit$sd2Stage[5] <- round((aggregate(Dfinal_11_13$predicted_cognitive_11~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  ttest_attritionTable_edit$sd2Stage[6] <- round((aggregate(Dfinal_11_13$EMPQ_cognitive_11~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  ttest_attritionTable_edit$sd2Stage[7] <- round((aggregate(Dfinal_11_13$predicted_cognitive_13~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
  ttest_attritionTable_edit$sd2Stage[8] <- round((aggregate(Dfinal_11_13$EMPQ_cognitive_13~Dfinal_11_13$whatStage, FUN = sd)[2,2]),2)
...
examining relations between questionnaire format (online/'manual'pencil and paper') and the study variables
equal variances between the groups ARE NOT assumed
```{r}

# at age 13 tim-point, some children received a short battery that did not include the emotion recognition test.
# as a first step, conduct ttest only for the difference between the short and long online versions:
...
#because there is no significant differnce, we unite the two online groups
...
#import partcipants age in each wave
...
examining differnces between DZ same-sex (DZS) and DZ opposite sex (DZO) twins
in order to decide whether these groups can be united
```{r}
...
#check difference between DZS and DZO -DO I NEED THIS? IF NOT ERASE
...
compute ICC of the new variables
```{r}
  col <- colnames(DWide)
...
Check the associations between the study variables and none-self-report empathy measures
```{r}
...
#import the data
  ...
  DEmoR <- read.csv ("subtle_facial_expressions_age13_edited_160622.csv")
  col <- colnames(DEmoR)
  relvar_EmoR <- c(which (col=="ifam"),which(col=="ID"), 
                   which(col=="ER_c"),which(col=="ER_c_neg"),which(col=="ER_c_pos"))
  DEmoRshort <- DEmoR[,relvar_EmoR]
  DEmoRshort <- DEmoRshort[complete.cases(DEmoRshort[which(colnames(DEmoRshort)=="ER_c")]),]
...
#examine the correlations between study variables and non-self report measures
  ...
  setwd("/Users/liorabramson/Dropbox/empathy and puberty/writing")  
